...
import { UpdateTodoDto } from '@orcha/todo/shared/domain';
import { OrchaOperationError } from '@orcha/common';
import { TodoStoreModel, TodoStoreSubscriptionResult } from './todo.reducer';
...
export const readTodosSuccess = createAction(
  ...
  props<{ todos: TodoStoreSubscriptionResult }>()
);
...
/*
   ...
   |_| \__,_\__, |_|_||_\__,_|\__\___|
            |___/                     
*/
export const paginateTodos = createAction('[Todos] Paginate Todos');
