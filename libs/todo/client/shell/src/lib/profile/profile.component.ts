...
import { AppFacade, UserOrchestration } from '@orcha/todo/client/domain';
import { EntireProfile } from '@orcha/todo/shared/domain';
...
export class ProfileComponent {
  ...
  constructor(private readonly _user: UserOrchestration, private app: AppFacade) {}
